...
@section('extra-script')
    ...
    <script>
        ...
        $('body').on('submit', '#quote_form',  function(event){
            event.preventDefault();
            let form = document.getElementById('quote_form');
            ...
            let failed = function(data){
                if(data.quote_no){
                    $("input[name='quote_no']").val(data.quote_no);
                    $(".quote_no-disabled").val(data.quote_no);
                }
