...
<form id="quote_form" class="form-horizontal" name="13" action="" enctype='multipart/form-data' method='post'>
    {{ csrf_field() }}
    <div class="col-md-12">
            ...
            <div class="col-md-8">
                <select name="account" class="form-control">
                    ...
                    @foreach($accounts as $account)
                        <option {{ $quote->account_id == $account->id ? 'selected' : '' }} value="{{ $account->id }}">{{ $account->name }}</option>
                    @endforeach
                </select>
                <br>
    ...
    <div class="col-md-4 clearfix">
        <div class="form-group clearfix">
            ...
            <div class="col-md-8">
                <input type="text" disabled="disabled" class="form-control disabled quote_no-disabled" value="{{ $quote->quote_no }}">
            ...
            <table class="table">
                <tbody class="quote-summary">
                    ...
                    <tr>
                        ...
                        <td class="f-s-16 f-w-600 text-right"> <span class="quote-currency">{{ $quote->currency ? $quote->currency->symbol  : '' }}</span> <span class="grand-total">{{ number_format($quote->grand_total, 2) }}</span></td>
                    </tr>
