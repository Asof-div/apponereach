...
@section('breadcrumb')
    ...
    <li><a href="{{ route('tenant.crm.contact.index', [$tenant->domain]) }}"> CONTACT </a></li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading"> 
                ...
                <div class="panel-title"> 
                    <span class="h3"> Show Contact </span> 
                    <span class="pull-right m-r-10">
                        <a href="{{ route('tenant.crm.contact.create', [$tenant->domain]) }}" class="btn btn-lg btn-outline-default"> <i class="fa fa-plus"></i> Add Contact </a>
                        ...
                        <a href="javascript:;" data-contact_id="{{ $contact->id }}" data-toggle="modal" data-target=".delete-contact-modal" class="btn btn-lg btn-outline-default"> <i class="fa fa-trash"></i> Delete Contact </a>
                    </span>
                </div> 
            ...
            <div class="panel-body" style="min-height: 400px;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12" >
                    ...
                    @include('app.tenant.crm.contact.partials.details')
...
@section('extra-script')
    ...
    <script>
        ...
        $('body').on('submit', '#edit_contact_form',  function(event){
            event.preventDefault();

            $("input[name='number'").val($("select[name='country_code'").val() + $("input[name='phone'").val());

            let form = document.getElementById('edit_contact_form');
            let formData = new FormData(form);

            url = "{{ route('tenant.crm.contact.update', [$tenant->domain] ) }}"; 
