<form id="edit_contact_form" class="form-horizontal" name="13" action="" enctype='multipart/form-data' method='post'>
	 ...
	 <div class="form-group bg-white clearfix p-15 m-r-0 m-l-0 m-t-15">
        <div class="pull-right" >
            ...
            <button class="btn btn-primary" type="submit"> <i class="fa fa-save"></i> Update Contact </button>
        </div>
    </div>     
