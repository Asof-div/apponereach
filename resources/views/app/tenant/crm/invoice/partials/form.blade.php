...
<form id="invoice_form" class="form-horizontal" name="13" action="" enctype='multipart/form-data' method='post'>
    {{ csrf_field() }}
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <select name="account" class="form-control">
                    <option value="">&dash; &dash; &dash; Select Account &dash; &dash; &dash;</option>
                    @foreach($accounts as $account)
                        <option {{ $invoice->account_id == $account->id ? 'selected' : '' }} value="{{ $account->id }}">{{ $account->name }}</option>
                    @endforeach
                </select>
                <br>
    ...
    <div class="col-md-4 clearfix">
        <div class="form-group clearfix">
            ...
            <div class="col-md-8">
                <input type="text" disabled="disabled" class="form-control disabled invoice_no-disabled" value="{{ $invoice->invoice_no }}">
            ...
            <table class="table">
                <tbody class="invoice-summary">
                    ...
                    <tr>
                        ...
                        <td class="f-s-16 f-w-600 text-right"> <span class="invoice-currency">{{ $invoice->currency ? $invoice->currency->symbol  : '' }}</span> <span class="grand-total">{{ number_format($invoice->grand_total, 2) }}</span></td>
                    </tr>
