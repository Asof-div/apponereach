    ...
    <div class="tab-content bg-silver">
        <div class="tab-pane fade clearfix active in" id="nav-activities">                 
            ...
            <div class="col-md-12">
                ...
                @foreach($ticket->comments->where('isInternal', false) as $comment)
                      ...
                      <div class="chat-body-overlay">
                          <div class="chat-messages">
                            ...
                            @foreach($ticket->chat_room->conversations as $conversation)
                              <div class="message{{ $conversation->sender_id != Auth::id() && $conversation->sender_type != 'App\Models\User' ? ' others' : '' }}">
                                <header>{{$conversation->sender_type() }} : {{ $conversation->sender_id != Auth::id() && $conversation->sender_type != 'App\Models\User' ? $conversation->sender ? $conversation->sender->name :' Unknown' : 'Me' }}</header>
        ...
        <div class="tab-pane fade clearfix" id="nav-resources">                 
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form id="resources-form" method="post" action="{{ route('tenant.ticket.resource', [$tenant->domain, $ticket->id])}}" accept-charset="utf-8" enctype="multipart/form-data">
