...
<div class="col-md-12 clearfix">
    ...
    <form id="tts_edit_form" name="13" action="" enctype='multipart/form-data' method='post'>
       
       {{csrf_field()}}
       <input type="hidden" name="tts_id" >
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 form-group clearfix">
            ...
            <div class="pull-right" >
                <button class="btn btn-sm btn-primary " type="submit"> <i class="fa fa-save"></i> Update Settings </button>
            </div>
        </div>
    </form>
