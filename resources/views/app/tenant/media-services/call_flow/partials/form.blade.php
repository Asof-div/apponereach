<div class="panel panel-with-tabs clearfix p-t-20" style="overflow-x: auto;">
    ...
    <form id="call_flow_form" class="form-horizontal" name="13" action="{{ route('tenant.media-service.call-flow.store', [$tenant->domain]) }}" enctype='multipart/form-data' method='post'>

        {{csrf_field()}}
     
        <input type="hidden" name="destination_value" value="{{ old('destination_value') }}" class="destination_value">        
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 ">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                ...
                <div class="col-md-9">
                    <input type="text" name="title" placeholder="24 Hour Call Flow" class="form-control" required="required" value="{{ old('title') }}" />                    
                </div>
        ...
        <div class="form-group bg-white clearfix p-10 m-r-25 m-l-25">
            <div class="col-md-4 col-sm-6 col-xs-6 col-md-offset-5 col-sm-offset-4" >
                <button class="btn btn-sm btn-primary " type="submit"> Save Call Flow </button>
            </div>
        </div> 
        @endif
    </form>
