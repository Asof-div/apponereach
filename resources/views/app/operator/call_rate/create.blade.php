...
@section('breadcrumb')
    ...
    <li><a href="{{ route('operator.call.rate.index') }}"> Pilot Number </a></li>
    <li class="active"> New Call Rate </li>
        ...
        <div class="panel ">
            <div class="panel-heading">
                <div class="panel-title pt-2">
                    <span class="h3"> &nbsp; Add New Call Rate
                    </span>
                </div>
            ...
            <div class="panel-body" style="min-height: 400px;">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 p-t-15 p-b-15 bg-silver">
                    ...
                    @include('app.operator.call_rate.partials.form')
...
@section('extra-script')
    ...
    <script>
        ...
        $('body').on('submit', '#rate_form',  function(event){
            ...
            url = "{{ route('operator.call.rate.store') }}";
