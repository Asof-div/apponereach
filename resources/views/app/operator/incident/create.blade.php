        ...
        <div class="panel ">
            <div class="panel-heading"> 
                <div class="panel-title pt-2">
                    <span class="h3"> &nbsp; Incidents 
                    </span>
                </div> 
                <span class="pull-right mr-2">
                    <a href="{{ route('operator.incident.index') }}" class="btn btn-success"> <i class="fa fa-list"></i> Incidents &nbsp; <span class="text-primary"> </span> </a>
                </span>
            ...
            <div class="panel-body" style="min-height: 400px;">
                ...
                <hr style="background-color: #51BB8D; height: 1px;" />

                <div class="col-md-12 col-sm-12 col-xs-12 p-t-15 p-b-15 bg-silver">

                    @include('app.operator.incident.partials.form')
