<div class="modal fade" id="EditPermissionModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('admin.permission.user.update', [$permission->id]) }}" method="POST">
				{{ csrf_field() }}
				{{ method_field('PUT') }}
...
<div class="modal fade" id="DeletePermissionModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('admin.permission.user.delete', [$permission->id]) }}" method="POST">
				{{ csrf_field() }}
				{{ method_field('DELETE') }}
...
<div class="modal fade" id="RevokeFromRoleModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('admin.permission.user.role.revoke', [$permission->id]) }}" method="POST">
				{{ csrf_field() }}
				{{ method_field('PUT') }}
