...
@section('content')
	...
	@section('breadcrumb')
        ...
        <li><a href="{{ route('admin.permission.user.index') }}">Permissions</a></li>
	...
	<section>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="m-b-20 text-right">
					...
					<a data-toggle="modal" data-target="#DeletePermissionModal" class="btn btn-default" href="{{ route('admin.permission.user.edit', [$permission->id]) }}"><i class="fa fa-remove"></i></a>
				</div>
				@endif
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<form action="{{ route('admin.permission.user.role.assign', [$permission->id]) }}" method="POST">
					{{ csrf_field() }}
					{{ method_field('PUT') }}
	...
	@include('admin.permission.user.includes.modal')
