                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="table-responsive">
                            ...
                            <table class="table table-condensed table-striped">
                                ...
                                <tr>
                                    <th>Status</th>
                                    <th>{{$customer->status? "ACTIVATED" : "DEACTIVATED"}}</th>
                                </tr>
                                <tr>
                                    <th>Valid</th>
                                    <th>{{$customer->validity }}</th>
                                </tr>
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            <input type="text" class="form-control" id="suggested_number" placeholder="Number" aria-describedby="basic-addon2">
    ...
    <script>
        ...
        $('body').on('submit', '#order_confirmation_form',  function(event){
            ...
            let success = function(data){
                ...
                setTimeout(function(){ 
                    window.location = "{{ route('operator.customer.show', [$customer->id]) }}";
        ...
        $('body').on('click', '.search-number', function(e){
            ...
            $('.resultContent').empty();
            let type = 'Local';
            let number = $('input#suggested_number').val();
