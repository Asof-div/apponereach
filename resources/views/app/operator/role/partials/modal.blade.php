<div class="modal fade" id="EditRoleModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('operator.role.update', [$role->id]) }}" method="POST">
				{{ csrf_field() }}
				{{ method_field('PUT') }}
...
<div class="modal fade" id="DeleteRoleModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('operator.role.delete', [$role->id]) }}" method="POST" permission="form">
				{{ csrf_field() }}
				{{ method_field('DELETE') }}
...
<div class="modal fade" id="RevokePermissionModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('operator.role.permission.revoke', [$role->id]) }}" method="POST">
				{{ csrf_field() }}
				{{ method_field('PUT') }}
...
<div class="modal fade" id="RevokeAccountModal">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{ route('operator.role.account.revoke', [$role->id]) }}" method="POST">
				{{ csrf_field() }}
				{{ method_field('PUT') }}
