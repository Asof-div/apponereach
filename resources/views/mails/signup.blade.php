...
<head>
    ...
    <link rel="icon" href="{{asset('images/9MOBILE_LOGO.png')}}">
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            ...
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        <a href="{{ url('/') }}" class="text-center " ><img width="50" height="50" src="{{asset('images/9Mobile.png')}}"> <span style="color: #222; font-size: 30px; margin-top: 15px; display: inline-block; margin-left: 10px;">  </span> </a>
                                                    </td>
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="last">
                                                    ...
                                                    <p class="m-b-5 f-s-15">Please click the following URL to activate your account:</p>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="wrapper">
                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    <p class="f-s-15">Your username is : {{ $user->email }}</p>
                                                    <p class="f-s-15">Your Package is : {{ $package->name }}</p>
                                                    <h4>Please to activate your account.</h4>
                                                    <p><a href="{{ route('tenant.index', [$tenant->domain]) }}"> Click here </a> </p>
                                                </td>
                                            </tr>
                                        </table>
                                        <!-- end twelve columns -->
                                        <h4>
                                            <i>NB: This ia a system generated email and reply is not required.</i>
                                        </h4>
                                    </td>
                                    <!-- end wrapper -->
                                </tr>
...
<!-- Mirrored from seantheme.com/color-admin-v1.7/admin/html/email_system.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Apr 2015 10:59:07 GMT -->
</html>
